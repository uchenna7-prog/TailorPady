    ...
    <div className={styles.template}>
      ...
      <div className={styles.header}>
        <div className={styles.logoArea}>
          ...
          <div>
            <div className={styles.companyName}>{(receiptBrandSettings.name || receiptBrandSettings.ownerName || 'YOUR BUSINESS').toUpperCase()}</div>
        ...
        <div className={styles.headerRight}>
          {receiptBrandSettings.phone && (
            <div className={styles.iconRow}>
              ...
              <span className={styles.noWrap}>{receiptBrandSettings.phone}</span>
            </div>
          )}
