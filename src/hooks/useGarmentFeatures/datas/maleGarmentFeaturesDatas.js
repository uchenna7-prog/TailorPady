...
import fullLength from '../../../assets/maleGarmentFeatures/lowerWearFeatures/length/fullLength.jpg'
import kneeLength from '../../../assets/maleGarmentFeatures/lowerWearFeatures/length/kneeLength.jpg'
import shortLength from '../../../assets/maleGarmentFeatures/lowerWearFeatures/length/shortLength.jpg'
import threeQuaterLength from '../../../assets/maleGarmentFeatures/lowerWearFeatures/length/threeQuaterLength.jpg'
...
import buttonDownCollar from '../../../assets/maleGarmentFeatures/upperWearFeatures/collarType/buttonDownCollar.jpg'
import classicCollar from '../../../assets/maleGarmentFeatures/upperWearFeatures/collarType/classicCollar.jpg'
import mandarinCollar from '../../../assets/maleGarmentFeatures/upperWearFeatures/collarType/mandarinCollar.jpg'

import angledShirtCuff from '../../../assets/maleGarmentFeatures/upperWearFeatures/shirtCuffType/angledShirtCuff.jpg'
import frenchAngledShirtCuff from '../../../assets/maleGarmentFeatures/upperWearFeatures/shirtCuffType/frenchAngledShirtCuff.jpg'
import frenchRoundedShirtCuff from '../../../assets/maleGarmentFeatures/upperWearFeatures/shirtCuffType/frenchRoundedShirtCuff.jpg'
import frenchShirtCuff from '../../../assets/maleGarmentFeatures/upperWearFeatures/shirtCuffType/frenchShirtCuff.jpg'
import frenchSquareShirtCuff from '../../../assets/maleGarmentFeatures/upperWearFeatures/shirtCuffType/frenchSquareShirtCuff.jpg'
import milaneseShirtCuff from '../../../assets/maleGarmentFeatures/upperWearFeatures/shirtCuffType/milaneseShirtCuff.jpg'
...
const MALE_COLLAR_IMGS = {
  buttonDown: buttonDownCollar,
  classic: classicCollar,
  mandarin: mandarinCollar,
}

const MALE_CUFF_IMGS = {
  angled: angledShirtCuff,
  frenchAngled: frenchAngledShirtCuff,
  frenchRounded: frenchRoundedShirtCuff,
  french: frenchShirtCuff,
  frenchSquare: frenchSquareShirtCuff,
  ...
  subSlots: [
    {
      ...
      label: '1 Pocket',
      options: [
        { id: 'jetted', label: 'Jetted', img: BACK_POCKET_IMGS.jettedOneBackPocket },
        { id: 'jetted_flap', label: 'Jetted with Flap', img: BACK_POCKET_IMGS.jettedOneBackPocketWithFlap },
        { id: 'jetted_tab', label: 'Jetted with Tab', img: BACK_POCKET_IMGS.jettedOneBackPocketWithTab },
        { id: 'jetted_zip', label: 'Jetted with Zip', img: BACK_POCKET_IMGS.jettedOneBackPocketWithZip },
        { id: 'welt', label: 'Welt', img: BACK_POCKET_IMGS.weltOneBackPocket },
        { id: 'welt_button', label: 'Welt with Button', img: BACK_POCKET_IMGS.weltOneBackPocketWithButton },
        { id: 'welt_topstitch', label: 'Welt with Top Stitch', img: BACK_POCKET_IMGS.weltOneBackPocketWithTopStitch },
      ],
    },
    {
      id: 'back_pocket_two',
      label: '2 Pockets',
      options: [
        { id: 'jetted', label: 'Jetted', img: BACK_POCKET_IMGS.jettedTwoBackPocket },
        { id: 'jetted_flap', label: 'Jetted with Flap', img: BACK_POCKET_IMGS.jettedTwoBackPocketWithFlap },
        { id: 'jetted_tab', label: 'Jetted with Tab', img: BACK_POCKET_IMGS.jettedTwoBackPocketWithTab },
        { id: 'jetted_zip', label: 'Jetted with Zip', img: BACK_POCKET_IMGS.jettedTwoBackPocketWithZip },
        { id: 'welt', label: 'Welt', img: BACK_POCKET_IMGS.weltTwoBackPocket },
        { id: 'welt_button', label: 'Welt with Button', img: BACK_POCKET_IMGS.weltTwoBackPocketWithButton },
        { id: 'welt_topstitch', label: 'Welt with Top Stitch', img: BACK_POCKET_IMGS.weltTwoBackPocketWithTopStitch },
      ],
    },
  ],
}

export const POCKET_SLOT_MALE_FRONT = {
  id: 'front_pocket',
  ...
  subSlots: [
    {
      ...
      label: '1 Pocket',
      options: [
        { id: 'classic', label: 'Classic', img: FRONT_POCKET_IMGS.classicOneFrontPocket },
        { id: 'round', label: 'Round', img: FRONT_POCKET_IMGS.roundOneFrontPocket },
        { id: 'square', label: 'Square', img: FRONT_POCKET_IMGS.squareOneFrontPocket },
      ],
    },
    {
      id: 'front_pocket_two',
      label: '2 Pockets',
      options: [
        { id: 'classic', label: 'Classic', img: FRONT_POCKET_IMGS.classicTwoFrontPocket },
        { id: 'round', label: 'Round', img: FRONT_POCKET_IMGS.roundTwoFrontPockets },
        { id: 'square', label: 'Square', img: FRONT_POCKET_IMGS.squareTwoFrontPockets },
      ],
    },
  ],
}
...
export const MALE_COLLAR_SLOT = {
  ...
  label: 'Collar Type',
  options: [
    { id: 'classic', label: 'Classic', img: MALE_COLLAR_IMGS.classic },
    { id: 'button_down', label: 'Button Down', img: MALE_COLLAR_IMGS.buttonDown },
    { id: 'mandarin', label: 'Mandarin', img: MALE_COLLAR_IMGS.mandarin },
  ],
}

export const MALE_CUFF_SLOT = {
  id: 'cuff_type',
  label: 'Shirt Cuff',
  options: [
    { id: 'angled', label: 'Angled', img: MALE_CUFF_IMGS.angled },
    { id: 'french_angled', label: 'French Angled', img: MALE_CUFF_IMGS.frenchAngled },
    { id: 'french_round', label: 'French Round', img: MALE_CUFF_IMGS.frenchRounded },
    { id: 'french', label: 'French', img: MALE_CUFF_IMGS.french },
    { id: 'french_square', label: 'French Square', img: MALE_CUFF_IMGS.frenchSquare },
