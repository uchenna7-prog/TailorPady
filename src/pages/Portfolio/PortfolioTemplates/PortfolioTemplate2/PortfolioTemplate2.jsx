...
const SOCIAL_ICONS = {
  ...
  twitter:   (<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.736-8.849L1.254 2.25H8.08l4.259 5.63L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z"/></svg>),
  youtube:   (<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M23.495 6.205a3.007 3.007 0 0 0-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 0 0 .527 6.205a31.247 31.247 0 0 0-.522 5.805 31.247 31.247 0 0 0 .522 5.783 3.007 3.007 0 0 0 2.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 0 0 2.088-2.088 31.247 31.247 0 0 0 .5-5.783 31.247 31.247 0 0 0-.5-5.805zM9.609 15.601V8.408l6.264 3.602z"/></svg>),
...
const PHONE_SVG = (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
    <path d="M5.5 3.5h3l1.6 4.4-2.1 1.7a13.6 13.6 0 006 6l1.7-2.1 4.4 1.6v3a2 2 0 01-2.2 2A17.5 17.5 0 013.5 5.7a2 2 0 012-2.2z"/>
  </svg>
)
...
export function PortfolioTemplate2({ brand, photos, garmentTypes, reviews }) {
  ...
  const stats = [
    ...
    { label: 'Years crafting', value: withPlus(yearsCrafting(settings.yearFounded)) },
  ]

  const facts = [
    { label: 'Based in',    value: settings.location,               icon: PIN_SVG },
    { label: 'Delivers to', value: settings.serviceArea.join(', '), icon: TRUCK_SVG },
    { label: 'Turnaround',  value: settings.turnaround,             icon: CLOCK_SVG },
    { label: 'Hours',       value: settings.businessHours,          icon: CALENDAR_SVG },
  ]
      ...
      <header className={`${styles.nav} ${scrolled ? styles.navScrolled : ''}`}>
        <div className={styles.navInner}>
          ...
          <nav className={styles.navLinks}>
            ...
            <button onClick={() => scrollTo(worksRef)} className={activeSection === 'work' ? styles.navLinkActive : ''}>Gallery</button>
        ...
        {navOpen && (
          <div className={styles.navMobilePanel}>
            ...
            <button onClick={() => scrollTo(worksRef)}>Gallery</button>
      ...
      <div className={styles.mainBody}>
          ...
          <div className={styles.aboutGrid}>
            <div className={styles.aboutLeft}>
              <Reveal as="div" className={styles.aboutIntro}>
                ...
                <p className={styles.aboutBio}>{brandBio || settings.about}</p>
              </Reveal>
        ...
        <section id="work" className={styles.works} ref={worksRef}>
          ...
          {categoryGroups.length === 0 ? (
            <div className={styles.worksEmpty}>Nothing in the Gallery yet, check back soon.</div>
          ) : (
        ...
        <section className={styles.process}>
          ...
          <div className={styles.processRail}>
            {settings.processSteps.map((step, i) => (
              <Reveal as="div" key={i} className={styles.processStep} delay={i * 90}>
                <div className={styles.processDot}>
                  <span className={styles.processDotNumber}>{String(i + 1).padStart(2, '0')}</span>
                </div>
        ...
        <footer className={styles.footer}>
          ...
          <div className={styles.footerTop}>
            ...
            <div className={styles.footerCol}>
              ...
              {brand.brandEmail && (
                <a href={`mailto:${brand.brandEmail}`} className={styles.footerRowItem}>
                  <span className={styles.footerRowIcon}>{MAIL_SVG}</span>
                  <span className={styles.footerRow}>{brand.brandEmail}</span>
                </a>
              )}
              {brand.brandPhone && (
                <a href={`tel:${brand.brandPhone}`} className={styles.footerRowItem}>
                  <span className={styles.footerRowIcon}>{PHONE_SVG}</span>
                  <span className={styles.footerRow}>{brand.brandPhone}</span>
                </a>
              )}
              {brand.brandAddress && (
                <span className={styles.footerRowItem}>
                  <span className={styles.footerRowIcon}>{PIN_SVG}</span>
            ...
            <div className={styles.footerCol}>
              ...
              <button onClick={() => scrollTo(worksRef)} className={styles.footerNavLink}>Gallery</button>
