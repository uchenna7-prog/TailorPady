  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.scrollArea}>
        ...
        <ContactRow iconNode={<WhatsAppIcon size={20} />} label="WhatsApp" value={CONTACT.whatsapp} href={WHATSAPP_HREF} />
        <ContactRow icon="call" label="Phone" value={CONTACT.phone} href={`tel:${CONTACT.phone.replace(/\s/g, '')}`} />
