export const TOURS = {
  onboarding: [
    ...
    },
    {
      ...
      message: 'Would you like to see the measurement you just saved, or go straight ahead and place an order for this customer?',
    ...
    },
    {
      ...
      target: null,
      title: 'Order created 🎉',
      message: 'Would you like to see the order you just created, or go ahead and create an invoice for it now?',
      viewLabel: 'View details',
